    ...
    <form className={cn("flex flex-col gap-6", className)} onSubmit={handleSubmit} {...props}>
      <FieldGroup>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Button variant="outline" className="w-full" type="button" disabled={isLoading} onClick={handleGoogleSignUp}>
          ...
          <Button variant="outline" className="w-full" type="button" disabled={isLoading} onClick={handleGitHubSignUp}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="mr-2 h-4 w-4">
              <path
