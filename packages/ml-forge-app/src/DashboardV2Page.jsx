...
export default function DashboardV2Page({ session, navigate, lockedTab = null }) {
    ...
    const AccountLottie = () => (
        <div className="flex flex-col items-center justify-center p-10 bg-[#080808]/50 border border-white/5 rounded-xl backdrop-blur-xl mb-8">
            <dotlottie-wc
                src="https://lottie.host/6303f435-2800-4f43-bbce-338709b83c84/cR1zJyjMGi.lottie"
                style={{ width: '300px', height: '300px' }}
                autoplay
                loop
            ></dotlottie-wc>
            <h2 className="text-2xl font-black italic uppercase mt-4 text-white tracking-tighter">Sovereign Account Workspace</h2>
            <p className="text-gray-500 text-sm mt-2 font-mono uppercase tracking-widest">Protocol Delta-9 Active</p>
        </div>
    )
