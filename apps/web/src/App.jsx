  ...
  return (
    <div className="page">
      ...
      <main>
        ...
        {!isLogin && !isSignup && !isHome && !isCheckout && !isDashboardV2 && !isAdminPath && footer}

        {isHome && !isLogin && !isSignup && !isCheckout && !isDashboardV2 && !isAdminPath && footer}
      </main>
    </div>
  )
}
